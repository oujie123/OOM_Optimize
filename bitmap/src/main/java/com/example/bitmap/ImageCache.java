...
import com.example.bitmap.disk.DiskLruCache;
...
public class ImageCache {
    ...
    public void init(Context context, String dir) {
        ...
        lruCache = new LruCache<String, Bitmap>(memoryClass * 1024 * 1024 / 8) {
            // 返回的一张图片大小
            // getAllocationByteCount() 相当于bitmap的大小，
            // getByteCount()图片的大小。如果图片大小大于bitmap，两个返回是相等的。
            @Override
            protected int sizeOf(String key, Bitmap value) {
                // Log.e("Jack","size：" + value.getAllocationByteCount());
                ...
                return value.getRowBytes() * value.getHeight();//other version
            }
